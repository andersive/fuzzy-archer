package ImagesAnimations;/* ImagesAnimations.ShowImage.java
...
public class ShowImage extends JPanel{
    ...
    public ShowImage(){
        ...
        // directory as ImagesAnimations.ShowImage.class.
        image = Toolkit.getDefaultToolkit().getImage("images/mong.jpg");
    }
...
// The following methods are instance methods.
    ...
    */
    ...
    public static void main(String arg[]){
        JFrame frame = new JFrame("ImagesAnimations.ShowImage");
